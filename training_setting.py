...
n2_parser.add_argument('--cuda_num', type=str, default='3', help='Which GPU')
n2_parser.add_argument('--trial_number', type=str, default='0', help='Which trail')
...
n2_parser.add_argument('--source', type=str, default='pyg', help='source of dataset')
